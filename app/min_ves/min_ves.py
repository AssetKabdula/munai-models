...
def load_models_and_scalers():
    ...
    nn_model = tf.keras.models.load_model(f'{BASE_DIR}/nn_model_min_ves.h5')
    xgb_model = joblib.load(f'{BASE_DIR}/xgb_model_min_ves.pkl')
    x_scaler = joblib.load(f'{BASE_DIR}/x_scaler_min_ves.pkl')
    y_scaler = joblib.load(f'{BASE_DIR}/y_scaler_min_ves.pkl')
...
def get_output_columns():
    ...
    return ['Мин. вес на долоте до спирального изгиба (бурение ротором)', 'Мин. вес на долоте до синусоидального изгиба (бурение ГЗД)',
                'Мин. вес на долоте до синусоидального изгиба (бурение ротором)', 'Мин. вес на долоте до спирального изгиба (бурение ГЗД)']  


# Make prediction with the model
def make_prediction_min_ves(input_data):
